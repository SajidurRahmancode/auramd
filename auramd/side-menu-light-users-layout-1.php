 ...
 -->
    ...
    <tbody> 
        ...
        ?>
                    ...
                    <td>
                        <a class="btn-elevated-primary" href="update.php?id=<?php echo $row['user_id']; ?>">Edit</a>&nbsp;
                        <a class="btn btn-danger" href="delete-user.php?id=<?php echo $row['user_id']; ?>">Delete</a>
                    </td>
