            ...
            <nav class="side-nav">
                ...
                <ul>
                    <li>
                        ...
                        <li>
                            <a href="AppForm.php" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="side-menu__title"> Set Appointment </div>
                            </a>
                        </li>
                        <li>
                            <a href="Appointment_Data.php" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="side-menu__title">Appointment Data</div>
                            </a>
                        </li>
                        <li>
                            <a href="Appointment_Graph.php" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="side-menu__title">Appointment Graph</div>
                            </a>
                        </li>
