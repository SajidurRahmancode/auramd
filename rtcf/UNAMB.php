            ...
            <nav class="side-nav">
                ...
                <ul>
                    <li>
                        ...
                        <li>
                            <a href="PolicyAdvoacy.php" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="side-menu__title">Policy Advocacy and Action  </div>
                            </a>
                        </li>
                        <li>
                            <a href="viewPolicy.php" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="side-menu__title">View Policy   </div>
                            </a>
                        </li>
                        
                        <li>
                            <a href="AE.html" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="side-menu__title"> Awareness & Education </div>
                            </a>
                        </li>
                        <li>
                            <a href="CEAE.html" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="side-menu__title"> Global Initiatives and Partnerships </div>
                            </a>
                        </li>
                        <li>
                            <a href="GIP.html" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                                <div class="side-menu__title"> Community Engagement & Events</div>
                            </a>
                        </li>
                    ...
                    <div class="intro-y box">
                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                            <h2 class="font-medium text-base mr-auto">
                                Bar Chart Of Carbon Footprint Per Year
                            </h2>
